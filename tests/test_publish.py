...
from dynprice.hass import HomeAssistantError
from dynprice.publish import build_states, publish
...
def test_alle_erwarteten_entitaeten_entstehen(settings):
    ...
    erwartet = {
        "sensor.dyn_price_ersparnis_folgetag",
        "sensor.dyn_price_ladefenster_start",
        "sensor.dyn_price_ladefenster_ende",
        "sensor.dyn_price_ladefenster_preis",
        "sensor.dyn_price_tagespreis",
        "sensor.dyn_price_netzbezug_prognose",
        "sensor.dyn_price_verschiebbare_energie",
        "sensor.dyn_price_speicherstatus",
        "binary_sensor.dyn_price_guenstiger_als_fixtarif",
    }
...
def test_speicherstatus_traegt_gruende(settings):
    ...
    value, attributes = states["sensor.dyn_price_speicherstatus"]
...
def test_ohne_fenster_bleibt_der_zeitstempel_unbekannt(settings):
    ...
    assert states["sensor.dyn_price_ladefenster_start"] == "unknown"
...
def test_publish_zaehlt_erfolge_und_haelt_fehler_aus(settings):
    ...
    mit_fehler = FakeHass(fail_for={"sensor.dyn_price_tagespreis"})
